...
public class SastreSanJuan implements Iuniforme {
  ...
  public Prenda fabricarPrendaSuperior() {
    ...
    borrador.construirPrenda(colorVerde,null, Material.PIQUE, null);
  ...
  public Prenda fabricarPrendaInferior() {
    ...
    borrador.construirPrenda(colorGris,null, Material.ACETATO, null);
  ...
  public Prenda fabricarPrendaCalzado() {
    ...
    borrador.construirPrenda(colorMarron,null, Material.CUERO, null);
